...
class State(BaseModel):
    ...
    validation_fg: List[Path | None] = []
    validation_bg: List[Path | None] = []
    validation_videos_mask: List[Path | None] = []

    using_deepspeed: bool = False


class State_I2V(BaseModel):
    model_config = {"arbitrary_types_allowed": True}
    ...
    validation_images: List[Path | None] = []
    validation_videos: List[Path | None] = []
    validation_videos_fg: List[Path | None] = []
    validation_videos_bg: List[Path | None] = []
    validation_videos_depth: List[Path | None] = []
    validation_videos_mask: List[Path | None] = []
